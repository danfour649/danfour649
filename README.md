...
- **Design and own GraphQL & REST APIs** — built a public **GraphQL (Apollo Server)** + REST API with OAuth 2.0 scope-based access, used by external program partners; schema design, type modeling, and contract stability.
